contract disassembler {
  ...
  // pair: 0x618CD2216955D73Ee8C679CD364Fb2d5dC613f81
  // token: 0xAc0C8dA4A4748d8d821A0973d00b157aA78C473D
  // param: ab34db1210148c761153d6f3d9e2f52f0ef0220a0a18353d55b8552112d539cc
  //
  // kill: 0x7d733DE66596c31E168c7eaBf99a9BB3f4a8Ac47
  function FUNC_00000003(uint256 arg0) public returns ()
  {
    ...
    uint32 const_a = uint32(SHR(0xB8,var4));

    if (MOD(block.number,0x64) < uint8(var4))
    {
      goto label_end;
    }
    ...
    else
    {
      ...
      if (const_a * 10**15 < reserve0) 
      {
        ...
        {
          //-> label_main:
          var8 = (10**15 * (0xFFFFFF & (SHR(0xE8,var4) / 0x10)));
          var9 = (10**15 * const_a);
          var10 = ((((0xFFFFFF & SHR(0xD4,var4)) / 0x10) & 0xFFFFFF) * 10**15);
          if ((((10**15 * const_a) + ((((0xFFFFFF & SHR(0xD4,var4)) / 0x10) & 0xFFFFFF) * 10**15)) > ((10**15 * (0xFFFFFF & (SHR(0xE8,var4) / 0x10))) + reserve0))) 
          {
            var12 = var8;
          }
          else
          ...
          var17 = func_00002548(var12,reserve0,reserve0);
    ...
    {
      var3 = func_000027AA(((58730 + ((var3 - gasleft) + (msg.data.length * 0x10))) / 42150));
    }
    return;
  }
